...
CREATE TABLE `applications` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`,`internship_id`),
  KEY `internship_id` (`internship_id`),
  CONSTRAINT `applications_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `applications_ibfk_2` FOREIGN KEY (`internship_id`) REFERENCES `internship_info` (`id`)
...
INSERT INTO `applications` VALUES (8,11,1,'2025-05-01 06:18:51');
